...
<?php
  	// require('class.php4.greeting.php');
	require('class.php5.greeting.php');
  	 ...
  	 * @var string
  	 */
  	$add_txt = '<p align="center">Send your greeting from <a href="www.armaniimus-webdevelopment.com">www.Armaniimus-webdevelopment.com</a><p>';

  	/**
  	 * Create greeting class
  	 * @var object
  	 */
  	$greeting = new Greeting($gc[$_POST['gc']]);

  	/**
  	 * Initialize greeting class attributes
  	 */
